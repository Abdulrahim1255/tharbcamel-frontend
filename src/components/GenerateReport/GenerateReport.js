            ...
            if(props.location.state){
                ...
                .then(res=>{
                    ...
                    if(res.data.msg==="success"){
                        ...
                        if(download){
                            props.history.push("/reportpdf",{negative,positive,suspect,comment,reportNumber,workOrderDate,mainDate,sampleQuantity:data.sampleQuantity,ownerName:data.ownerName,workOrder:`${workOrderDate}-B${newOrderNumber}`})
                        }else{
                ...
                negative.map((item,index)=>(
                    <tr key={index}>
                        ...
                        >
                            ...
                            <FormControlLabel value="noblood" disabled={item.judgement==="noblood"?true:false}  control={<Radio />} label="noblood" />
                        </RadioGroup>
                        </FormControl>
                        </td>
                    </tr>
                ...
                positive.map((item,index)=>(
                    <tr key={index}>
                        ...
                        >
                            ...
                            <FormControlLabel value="noblood"  control={<Radio />} label="noblood" />
                        </RadioGroup>
                        </FormControl>
                        </td>
                    </tr>
                ...
                suspect.map((item,index)=>(
                    <tr key={index}>
                        ...
                        >
                            ...
                            <FormControlLabel value="noblood" disabled control={<Radio />} label="noblood" />
                        </RadioGroup>
                        </FormControl>
                        </td>
                    </tr>
